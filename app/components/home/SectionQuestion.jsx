    ...
    <section>
      ...
      <div className="grid lg:grid-cols-2 gap-6 mt-4 md:mt-12">
        <div className="overflow-hidden w-full h-[250px] rounded md:h-[400px] mx-auto">
          <Image
            src="/question/image-question.jpg"
            width={800}
            height={800}
            alt="imagen pregunta frecuente"
            className="object-cover hover:scale-105 h-full w-full transition-all duration-300 ease-in-out transform"
          />
        </div>
        <div>
            ...
            <div key={index} className="mb-2">
              ...
              {expandedIndex === index && (
                <div className="bg-gray-50 border-l-4 border-primary p-4">
                  <p className="text-description">{q.answer}</p>
                </div>
              )}
            </div>
          ))}
